...
- [x] **Universal types** (required) **Vadym**
...
- [x] **Type applications** (required) **Gaetan**
...
- [x] **Recursive abstractions** (required) **Gaetan**
...
- [x] **Multiple parameters and arguments** (optional) **Raphael**
...
- [x] **Built-in arithmetic and comparison** (optional) **Raphael**
